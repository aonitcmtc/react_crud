...
export const HeroesDetail = () => {
    ...
    return (
        <div className="flex flex-col items-center p-8 min-h-screen bg-gray-800 text-white">
            <div className="flex flex-col md:flex-rowmd:gap-4 .md:w-[calc(80%+1rem)].lg:w-[calc(70%+1rem)] items-center py-5 px-3 border-dashed border-2 rounded-xl">
                <div className="flex flex-col items-center w-full">
                    <a href={link} target="_blank">
                        <p className="font-mono font-bold-text-2xl lg:3xl text-center hover:text-gray-300">
                            { heroesName }
                        </p>
                    </a>
            ...
            <button onClick={() => setLocation(`/heroes`) } className="text-black bg-white rounded-lg p-2 mt-3 h-10">
                GoBack
            </button>
